...
def main(config):
    if not ray.is_initialized():
        ...
        print(config)
        ray.init(runtime_env={'env_vars': {'TOKENIZERS_PARALLELISM': 'true', 'NCCL_DEBUG': 'WARN', 'EXPERIMENT_NAME': config.trainer.experiment_name}})
...
def main_task(config):
    ...
    # config.data.use_chat_template = True
